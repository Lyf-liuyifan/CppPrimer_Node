...
构造函数的调用顺序：创建派生类对象会马上调用派生类的构造函数，但在初始化列表的最开始调用基类的构造函数。
...
<img src="7.继承.assets/image-20240502174639321.png" alt="image-20240502174639321" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20240502175915371.png" alt="image-20240502175915371" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20240503105653403.png" alt="image-20240503105653403" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20240503105923093.png" alt="image-20240503105923093" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20240503110434075.png" alt="image-20240503110434075" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20231102131853385.png" alt="image-20231102131853385" style="zoom:80%;" />
...
<img src="7.继承.assets/image-20231102162819551.png" alt="image-20231102162819551" style="zoom:67%;" />

<img src="7.继承.assets/image-20231102162736728.png" alt="image-20231102162736728" style="zoom: 80%;" />
...
在C++中，派生类向基类进行转型是一个常见的操作，主要有以下几个原因：

1. **多态性支持：** C++中的多态性允许基类的指针或引用指向派生类的对象。当我们需要使用基类指针或引用来操作派生类对象时，就需要将派生类对象转换为基类类型。这样做可以使代码更加通用和灵活。
2. **接口统一：** 当有一组对象，它们都是从同一个基类派生而来，但是在某些情况下，我们需要对它们统一处理。通过将派生类对象转型为基类类型，我们可以使用同样的接口和方法处理它们，而不需要考虑具体的派生类。
3. **基类操作：** 如果我们有一个函数或方法接受基类对象作为参数，但实际上我们希望传递一个派生类对象，这时候就需要进行转型。
4. **向上转型和向下转型：** 向上转型是指将派生类对象转换为基类类型，向下转型是指将基类指针或引用转换为派生类类型。这种转型在面向对象编程中非常常见，可以实现类层次结构中的对象关系。

尽管派生类向基类转型在某些情况下是必要的，但是需要谨慎使用，因为转型可能会丢失派生类特有的属性和方法，而且如果转型不正确，还可能导致程序错误。
...
<img src="7.继承.assets/image-20240503144137094.png" alt="image-20240503144137094" style="zoom:67%;" />
...
> Derived d1;
> Base * pbase = &d1;
> //如果想把pbase转型成Derived*是合理的
> ```
>
> 
>
> <img src="7.继承.assets/undefined202403181753719.png" alt="image-20240318175300618" style="zoom:67%;" />
...
<img src="7.继承.assets/image-20240503145904285.png" alt="image-20240503145904285" style="zoom:67%;" />



**结论：可以用派生类对象赋值给基类对象（用基类对象接受派生类对象的赋值），可以用基类指针指向派生类对象，可以用基类引用绑定派生类对象。**
